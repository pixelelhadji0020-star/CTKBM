...
export default function InstallBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-black border-t border-[#C9A84C]/40 px-4 py-3 flex items-center gap-3">
      ...
      <button
        ...
        className="bg-[#C9A84C] text-black text-sm font-semibold px-4 py-2 rounded-full flex-shrink-0"
      >
        Installer
      </button>
      <button
